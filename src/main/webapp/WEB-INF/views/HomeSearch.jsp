...
<html>
	<head>
		...
		<script src="https://apis.openapi.sk.com/tmap/jsv2?version=1&appKey=l7xx44283537d5a349a3aac2a935278d2a8a"></script>
			...
			function initTmap() {
				...
				$("#btn_select").click(function() {
					...
					$.ajax({
						...
						async : false,
						data : {
							"appKey" : "l7xx44283537d5a349a3aac2a935278d2a8a",
							"coordType" : "WGS84GEO",
							"fullAddr" : fullAddr
						},
