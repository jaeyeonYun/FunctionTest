        ...
        <div class="row">
            <div class="col-lg-6 order-lg-2">
                <div class="pt-recipe-item large-item">
                    <div class="pt-recipe-img set-bg" data-setbg="resources/img/recipe-3.jpg">
            ...
            <div class="col-lg-3 col-md-6 order-lg-1">
                <div class="pt-recipe-item">
                    <div class="pt-recipe-img set-bg" data-setbg="resources/img/recipe-1.jpg">
                        <i class="fa fa-plus"></i>
                    </div>
                    <div class="pt-recipe-text">
                ...
                <div class="pt-recipe-item">
                    <div class="pt-recipe-img set-bg" data-setbg="resources/img/recipe-2.jpg">
                        <i class="fa fa-plus"></i>
                    </div>
                    <div class="pt-recipe-text">
            ...
            <div class="col-lg-3 col-md-6 order-lg-3">
                <div class="pt-recipe-item">
                    <div class="pt-recipe-img set-bg" data-setbg="resources/img/recipe-4.jpg">
                        <i class="fa fa-plus"></i>
                    </div>
                    <div class="pt-recipe-text">
                ...
                <div class="pt-recipe-item">
                    <div class="pt-recipe-img set-bg" data-setbg="resources/img/recipe-5.jpg">
                        <i class="fa fa-plus"></i>
                    </div>
                    <div class="pt-recipe-text">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="top-recipe-item large-item">
                    <div class="top-recipe-img set-bg" data-setbg="resources/img/top-recipe/recipe-1.jpg">
                        <i class="fa fa-plus"></i>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="top-recipe-item">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="top-recipe-img set-bg" data-setbg="resources/img/top-recipe/recipe-2.jpg">
                                <i class="fa fa-plus"></i>
                            </div>
                        </div>
                        <div class="col-sm-8">
                ...
                <div class="top-recipe-item">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="top-recipe-img set-bg" data-setbg="resources/img/top-recipe/recipe-3.jpg">
                                <i class="fa fa-plus"></i>
                            </div>
                        </div>
                        <div class="col-sm-8">
                ...
                <div class="top-recipe-item">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="top-recipe-img set-bg" data-setbg="resources/img/top-recipe/recipe-4.jpg">
                                <i class="fa fa-plus"></i>
                            </div>
                        </div>
                        <div class="col-sm-8">
                ...
                <div class="top-recipe-item">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="top-recipe-img set-bg" data-setbg="resources/img/top-recipe/recipe-5.jpg">
                                <i class="fa fa-plus"></i>
                            </div>
                        </div>
                        <div class="col-sm-8">
        ...
        <div class="cf-filter" id="category-filter">
            <div class="cf-item mix all mostpopular">
                <div class="cf-item-pic">
                    <img src="resources/img/cate-filter/cate-filter-1.jpg" alt="">
                </div>
            ...
            <div class="cf-item mix all mostpopular">
                <div class="cf-item-pic">
                    <img src="resources/img/cate-filter/cate-filter-2.jpg" alt="">
                </div>
                <div class="cf-item-text">
                    <h5>Sunday Brunch: Spaghetti and Eggs Recipe</h5>
                </div>
            ...
            <div class="cf-item mix all meatlover mostpopular">
                <div class="cf-item-pic">
                    <img src="resources/img/cate-filter/cate-filter-3.jpg" alt="">
                </div>
                <div class="cf-item-text">
                    <h5>Sunday Brunch: Spaghetti and Eggs Recipe</h5>
                </div>
            ...
            <div class="cf-item mix all meatlover">
                <div class="cf-item-pic glutenfree">
                    <img src="resources/img/cate-filter/cate-filter-4.jpg" alt="">
                </div>
                <div class="cf-item-text">
                    <h5>Sunday Brunch: Spaghetti and Eggs Recipe</h5>
                </div>
            ...
            <div class="cf-item mix all meatlover glutenfree">
                <div class="cf-item-pic">
                    <img src="resources/img/cate-filter/cate-filter-5.jpg" alt="">
                </div>
                <div class="cf-item-text">
                    <h5>Sunday Brunch: Spaghetti and Eggs Recipe</h5>
                </div>
    ...
    <div class="container po-relative">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="fr-item">
                    <div class="fr-item-img">
                        <img src="resources/img/feature-1.jpg" alt="">
                    </div>
            ...
            <div class="col-lg-6">
                <div class="fr-item">
                    <div class="fr-item-img">
                        <img src="resources/img/feature-2.jpg" alt="">
                    </div>
                    <div class="fr-item-text">
                        <h4>Sunday Brunch: Spaghetti and Eggs Recipe</h4>
